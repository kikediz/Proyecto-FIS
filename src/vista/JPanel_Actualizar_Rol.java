...
public class JPanel_Actualizar_Rol extends JPanel implements Panels{
    ...
    private void construir(){
        ...
        id_rol_JLabel.setFont(new java.awt.Font("Dustismo", 1, 26)); // NOI18N
        ...
        add(id_rol_JTextField, new GBConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new java.awt.Insets(32, 27, 36, 26), 0, 0));
        
        nombre_rol_JLabel.setFont(new java.awt.Font("Dustismo", 1, 26)); // NOI18N
        ...
        add(nombre_rol_JTextField, new GBConstraints(1, 1, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new java.awt.Insets(32, 27, 36, 26), 0, 0));
