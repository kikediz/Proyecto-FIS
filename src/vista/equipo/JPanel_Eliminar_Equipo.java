...
public class JPanel_Eliminar_Equipo extends JPanel implements Panels{
    ...
    private void construir(){
        ...
        eliminar_JButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/eliminar.png"))); // NOI18N
        ...
        add(eliminar_JButton, new GBConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, 0, new java.awt.Insets(5, 5, 5, 5), 10, 10));
