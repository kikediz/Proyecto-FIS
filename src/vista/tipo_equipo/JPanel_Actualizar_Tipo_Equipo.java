...
public class JPanel_Actualizar_Tipo_Equipo extends JPanel implements Panels{
    ...
    private void construir(){
        ...
        id_tipo_equipo_JLabel.setFont(new java.awt.Font("Dustismo", 1, 26)); // NOI18N
        ...
        add(id_tipo_equipo_JTextField, new GBConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new java.awt.Insets(32, 27, 36, 26), 0, 0));
        
        descripcion_JLabel.setFont(new java.awt.Font("Dustismo", 1, 26)); // NOI18N
        ...
        add(descripcion_JTextArea, new GBConstraints(1, 1, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new java.awt.Insets(32, 27, 36, 26), 0, 0));
