...
public class JPanel_Actualizar_Mantenimiento extends JPanel implements Panels{
    ...
    private void construir(){
        ...
        add(id_mantenimiento_JTextField, new GBConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new java.awt.Insets(32, 27, 36, 26), 0, 0));
