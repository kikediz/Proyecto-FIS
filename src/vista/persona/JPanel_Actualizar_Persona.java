...
public class JPanel_Actualizar_Persona extends JPanel implements Panels{
    ...
    private void construir(){
        ...
        add(cedula_JTextField, new GBConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new java.awt.Insets(32, 27, 36, 26), 0, 0));
        ...
        apellido_JLabel.setFont(new java.awt.Font("Dustismo", 1, 26)); // NOI18N
        ...
        add(apellido_JTextField, new GBConstraints(1, 2, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new java.awt.Insets(32, 27, 36, 26), 0, 0));
